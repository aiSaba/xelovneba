package
{
	...
	public class PaintDNaturmorti extends MovieClip
	{
		...
		private function closeBoxFunc(e:MouseEvent):void
		{
			...
			dNaturmortiPaint.paintbox.x = old_X;
			dNaturmortiPaint.paintbox.y = old_Y;
			Mouse.show();
		...
		{
			dNaturmortiPaint.paintbox.x = ev.stageX - dNaturmortiPaint.width / 2// - 3*dNaturmortiPaint.paintbox.paintcolor.width ;
			dNaturmortiPaint.paintbox.y = ev.stageY - dNaturmortiPaint.height / 2 //- dNaturmortiPaint.paintbox.paintcolor.height;
		}
		...
		{
			//dNaturmortiPaint.alln.paintbox.x = mouseX;
			//	dNaturmortiPaint.alln.paintbox.y = mouseY;
		}
		...
		private function colors():void
		{
			...
			dNaturmortiPaint.paintbox.paintcolor.transform.colorTransform = color;
		}
