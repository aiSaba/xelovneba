package
{
	...
	public class PaintQali extends MovieClip
	{
		...
		{
			trace("asd")
			qaliPaint.paintbox.x = old_X;
			qaliPaint.paintbox.y = old_Y;
		...
		{
			qaliPaint.paintbox.x = ev.stageX - qaliPaint.width / 2 // -// 3*qaliPaint.paintbox.paintcolor.width / 2;
			qaliPaint.paintbox.y = ev.stageY - qaliPaint.height / 2// - 3*qaliPaint.paintbox.paintcolor.height / 2;
		}
		...
		{
			//qaliPaint.paintbox.x = mouseX;
			//	qaliPaint.paintbox.y = mouseY;
		}
		...
		private function colors():void
		{
			...
			qaliPaint.paintbox.paintcolor.transform.colorTransform = color;
		}
