package  
{
	...
	public class Ferwera extends MovieClip
	{
		...
		public function Ferwera(_stageWidth:Number = 1024, _stageHeight:Number = 768)
		{
		...
		{
			IIpicsGrap._Grafic_1.removeEventListener(MouseEvent.MOUSE_DOWN, _showFunc_1);
			IIpicsGrap._Grafic_2.removeEventListener(MouseEvent.MOUSE_DOWN, _showFunc_2);
			IIpicsGrap._Grafic_3.removeEventListener(MouseEvent.MOUSE_DOWN, _showFunc_3);
		...
		{
			IIIpicsGrap._3Grafic_1.removeEventListener(MouseEvent.MOUSE_DOWN, _3showFunc_1);
			IIIpicsGrap._3Grafic_2.removeEventListener(MouseEvent.MOUSE_DOWN, _3showFunc_2);
			IIIpicsGrap._3Grafic_3.removeEventListener(MouseEvent.MOUSE_DOWN, _3showFunc_3);
