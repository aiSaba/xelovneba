package  
{
	...
	public class Ornamenti extends MovieClip
	{
		...
		public function Ornamenti(_stageWidth:Number = 1024, _stageHeight:Number = 768)
		{
		...
		{
			IIpicsGrap.Grafic_1.removeEventListener(MouseEvent.MOUSE_DOWN, showFunc_1);

			IIpicsGrap.Grafic_1_show.button_Exit.removeEventListener(MouseEvent.MOUSE_DOWN, nonshowFunc_1);
		...
		{
			IIIpicsGrap.Grafic_1.removeEventListener(MouseEvent.MOUSE_DOWN, showFunc_1);

			IIIpicsGrap.Grafic_1_show.button_Exit.removeEventListener(MouseEvent.MOUSE_DOWN, nonshowFunc_1);
